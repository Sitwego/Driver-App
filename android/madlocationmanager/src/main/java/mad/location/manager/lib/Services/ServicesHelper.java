...
public class ServicesHelper {
    ...
    public static LocationServiceInterface getLocationService() {
        return (LocationServiceInterface) instance.kalmanLocationService;
    }
    ...
    public static void disconnect(Context context) {
        if (instance.kalmanLocationService != null) {
            ...
            try {
                context.getApplicationContext().unbindService(instance.locationServiceConnection);
            } catch (Exception e) {
                // ignore if not currently bound
                Log.e("KalmanLocationService", "Error unbinding service", e);
            }
            instance.kalmanLocationService = null;
            instance.connectingLocationService = false;
            instance.locationServiceRequests.clear();
        }
    }
}
